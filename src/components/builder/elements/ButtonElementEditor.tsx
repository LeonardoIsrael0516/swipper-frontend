      ...
      <div className="space-y-4">
        ...
        {reel?.gamificationConfig?.enabled && (
          <div className="mt-6 pt-6 border-t border-border/50 space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Configure quais elementos de gamificação aparecem quando este botão é clicado. Sobrescreve configurações do slide.
            </p>
              ...
              <AccordionItem value="gamification">
                ...
                <AccordionContent className="space-y-4 pt-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {[
                        { key: 'onButtonClick', label: 'Ao clicar neste botão' },
