  ...
  return (
    ...
    >
      ...
      */}
      ...
      <div className="w-full h-full min-h-0 max-w-[1920px] mx-auto flex flex-col justify-start reel-content-inner md:w-auto md:max-w-none md:aspect-[9/20] md:max-h-[90vh]">
        {children}
      </div>
    </div>
  );
