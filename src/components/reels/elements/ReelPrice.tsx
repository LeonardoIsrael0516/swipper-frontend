...
interface ReelPriceProps {
  element: SlideElement;
  onButtonClick?: (url: string, openInNewTab: boolean) => void;
  className?: string;
}

export const ReelPrice = memo(function ReelPrice({ element, onButtonClick, className = '' }: ReelPriceProps) {
  ...
  return (
    <div style={cardStyle} className={cn('flex flex-col gap-4', className)}>
